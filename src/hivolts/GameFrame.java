...
public class GameFrame extends JComponent {
    /**
     hivolts.GameFrame written by Aaron and Josh (methods written and edited to the point
    ...
    // images
    public Image MhoFront = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoFront1.png"));
    public Image MhoRight = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoRight1.png"));
    public Image MhoLeft = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoLeft1.png"));
    public Image MhoBack = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoBack1.png"));
    public Image MhoEat = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoEat1.png"));
    public Image CharFront = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerFront1.png"));
    public Image CharRight = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerRight1.png"));
    public Image CharLeft = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerLeft1.png"));
    public Image CharBack = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerBack1.png"));
    public Image CharWin = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerCheer1.png"));
    public Image Fence = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/fence1.png"));
    ...
    public void playThemeMusic(){ // called in hivolts.Hivolts.initializeHivolts, plays theme song
        try{
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(this.getClass().getResource("/img/themesong.wav"));
    ...
    public void spawnMho() { // spawns mhos
        ...
        for (int i = 0; i < mhoCount; i++) { // runs as many times as there are mhos
            Mho newMho = new Mho(openPositionList.get(i).x, openPositionList.get(i).y); // new hivolts.Mho instance
    ...
    public void spawnFence() { // spawns fences
        ...
        for (int i = mhoCount; i < fenceCount + mhoCount; i++) { // runs as many times as there are inner fences
            hivolts.Fence newFence = new Fence(openPositionList.get(i).x, openPositionList.get(i).y); // new npc instance
    ...
    public void switchSprites(){
        if(animImage == true){
            MhoFront = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoFront1.png"));
            MhoRight = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoRight1.png"));
            MhoLeft = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoLeft1.png"));
            MhoBack = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoBack1.png"));
            MhoEat = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoEat1.png"));
            CharFront = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerFront1.png"));
            CharRight = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerRight1.png"));
            CharLeft = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerLeft1.png"));
            CharBack = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerBack1.png"));
            CharWin = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerCheer1.png"));
            Fence = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/fence1.png"));
        } else {
            MhoFront = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoFront2.png"));
            MhoRight = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoRight2.png"));
            MhoLeft = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoLeft2.png"));
            MhoBack = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoBack2.png"));
            MhoEat = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/mhoEat2.png"));
            CharFront = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerFront2.png"));
            CharRight = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerRight2.png"));
            CharLeft = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerLeft2.png"));
            CharBack = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerBack2.png"));
            CharWin = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/playerCheer2.png"));
            Fence = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("/img/fence2.png"));
        }
        animImage=!animImage;
    }
    ...
    private void drawWallsAndBorders(Graphics g) {
        for (int i = 0; i < 12; i++) {
            for (int n = 0; n < 12; n++) {
                if (objectLocations[i][n] instanceof hivolts.Fence) {
                    Graphics2D g2 = (Graphics2D) g;
